...
public class PA11Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // when the command is TIME
            ...
            // time interval and cost for my method
            startTime = System.nanoTime();
            tspCost = dGraph.tspMine(1, tspCycle);
            ...
            System.out.println("mine: cost = " + tspCost + ", " + duration + " milliseconds.");
            ...
            startIndex = tspCycle.size() - numVertices;
            for (int i = startIndex; i < tspCycle.size(); i++){
                minPath.add(tspCycle.get(i));
            }
